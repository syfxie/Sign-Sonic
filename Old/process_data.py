...
def video_to_frames(source_path, dest_path, size=(512, 512)):
    """
    source_path -> str, path to folder containing Videos.
    dest_path -> str, path to folder for frames.
    size -> (int, int), width, height of frame.
    """
    frames = []
